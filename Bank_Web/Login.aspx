...
<asp:Content ID="Content2" ContentPlaceHolderID="c1" runat="server">
    ...
    <div class="auto-style12" style="background-image: url('images/Login-Landing%20page/Group%2026.png'); display: block;">
        ...
        <asp:MultiView ID="MultiViewLogin" runat="server" OnActiveViewChanged="RegisterView_ActiveViewChanged" ActiveViewIndex="-1">
            ...
            <asp:View ID="viewRegister" runat="server">
                <div id="registerView">
                    <h2 style="text-align:center; font-family:'Segoe UI'; color:white" class="auto-style77">Register</h2>
                    <br />
                <table class="auto-style42">
                    <tr>
                        <td class="auto-style43" style="color: #FFFFFF; font-family: 'segoe UI', Tahoma, Geneva, Verdana, sans-serif">Full Name:</td>
                        <td class="auto-style44">&nbsp;<asp:TextBox ID="txtCustName" runat="server" CssClass="auto-style66" Height="20px" Width="320px"></asp:TextBox>
                            <br />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style53">&nbsp;<asp:TextBox ID="txtCustTelephone" runat="server" CssClass="auto-style68" Height="21px" Width="320px"></asp:TextBox>
                        </td>
                        <td class="auto-style54">
                    ...
                    <tr>
                        ...
                        <td class="auto-style57">&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnAddCustomer" runat="server" BackColor="#99CCFF" OnClick="btnAddCustomer_Click" Text="Submit" Width="135px" ValidationGroup="valGroupRegister" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <asp:View ID="LoginView" runat="server">
                    <div id="loginView">
                        <h2 style="text-align:center; font-family:'Segoe UI'; color:white" class="auto-style77">Login</h2>
                        <br />
